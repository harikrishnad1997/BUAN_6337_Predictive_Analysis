...
Ans: lm2 has the highest R-squared value. It makes sense that this has the best fit as the sales variable usually been increasing exponentially.
...
Ans: ln_User_Count has a p_value > 0.05. There we cannot reject the null hypothesis i.e. the coefficeint of ln_user_count = 0.